...
const Login = () => {
    ...
    return ( 
        <div className=''>
            <form className='flex flex-col w-1/3 bg-white m-auto mt-20 shadow-2xl rounded-2xl' onSubmit={handleSubmit}>
                <h3 className='text-4xl font-semibold mx-auto mt-5 border-b-2 w-1/2 text-center pb-2 border-green-500 mb-8'>Login</h3>
